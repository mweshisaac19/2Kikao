...
private val KikaoBackground = Color(0xFFF8FAFC)
...
private fun RoleCard(
    ...
    Card(
        ...
        colors = CardDefaults.cardColors(
            containerColor = if (isSelected) KikaoIndigo else Color.White
        )
    ) {
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Text(
                ...
                color = if (isSelected) Color.White.copy(alpha = 0.8f) else KikaoMutedText,
                fontSize = 13.sp
            )
        }
    }
